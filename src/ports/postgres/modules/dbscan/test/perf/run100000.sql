...
SELECT madlib.dbscan('input_blobs_03d_3c_200s_100000p', 'output_blobs_03d_3c_200s_100000p', 'id', 'point', 0.0180, 3, 'squared_dist_norm2', 'kd_tree');
...
SELECT madlib.dbscan('input_blobs_04d_4c_150s_100000p', 'output_blobs_04d_4c_150s_100000p', 'id', 'point', 0.0300, 3, 'squared_dist_norm2', 'kd_tree');
...
SELECT madlib.dbscan('input_blobs_09d_5c_100s_100000p', 'output_blobs_09d_5c_100s_100000p', 'id', 'point', 0.0400, 3, 'squared_dist_norm2', 'kd_tree');
...
SELECT madlib.dbscan('input_blobs_16d_6c_007s_100000p', 'output_blobs_16d_6c_007s_100000p', 'id', 'point', 0.0007, 3, 'squared_dist_norm2', 'kd_tree');
...
SELECT madlib.dbscan('input_blobs_25d_7c_006s_100000p', 'output_blobs_25d_7c_006s_100000p', 'id', 'point', 0.0009, 3, 'squared_dist_norm2', 'kd_tree');
...
SELECT madlib.dbscan('input_blobs_36d_8c_005s_100000p', 'output_blobs_36d_8c_005s_100000p', 'id', 'point', 0.0012, 3, 'squared_dist_norm2', 'kd_tree');
...
SELECT madlib.dbscan('input_blobs_49d_9c_004s_100000p', 'output_blobs_49d_9c_004s_100000p', 'id', 'point', 0.0009, 3, 'squared_dist_norm2', 'kd_tree');
...
SELECT madlib.dbscan('input_blobs_64d_10c_003s_100000p', 'output_blobs_64d_10c_003s_100000p', 'id', 'point', 0.0008, 3, 'squared_dist_norm2', 'kd_tree');
